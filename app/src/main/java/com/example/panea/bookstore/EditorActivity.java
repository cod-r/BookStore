...
public class EditorActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSubButton = (Button) findViewById(R.id.sub_one_from_quantity);
        mAddButton = (Button) findViewById(R.id.add_one_to_quantity);
        ...
        // Add one to the quantity edit text field
        ...
        // Subtract one from the quantity edit text field
...
//        values.put(PetEntry.COLUMN_PET_WEIGHT, weight);
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int supplierNameColumnIndex = cursor.getColumnIndex(BookEntry.BOOK_SUPPLIER_NAME);
            int supplierPhoneColumnIndex = cursor.getColumnIndex(BookEntry.BOOK_SUPPLIER_PHONE);
